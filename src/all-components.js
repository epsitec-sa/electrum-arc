...
import _NoteDrag from './components/time/note-drag.component.js';
import _NoteDrag$styles from './components/time/note-drag.styles.js';
...
export const NoteDrag = Electrum.wrap ('NoteDrag', _NoteDrag, {styles: _NoteDrag$styles});
export const Note = Electrum.wrap ('Note', _Note);
