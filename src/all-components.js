...
import _Chrono from './components/events/chrono.component.js';
import _Chrono$styles from './components/events/chrono.styles.js';
...
export const Chrono = Electrum.wrap ('Chrono', _Chrono, {styles: _Chrono$styles});
